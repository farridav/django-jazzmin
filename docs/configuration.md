...
JAZZMIN_SETTINGS = {
    ...
    # Custom icons for side menu apps/models See https://fontawesome.com/v6/search?m=free
    # for the full list of 6.1 free icon classes
    "icons": {
...
Example:
    ...
    "custom_links": {
        "books": [{
            ...
            # any font-awesome icon, see list here https://fontawesome.com/v6/search?m=free (optional)
            "icon": "fas fa-comments",                  
