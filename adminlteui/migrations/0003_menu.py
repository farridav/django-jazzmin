...
class Migration(migrations.Migration):
    ...
    dependencies = [('contenttypes', '0002_remove_content_type_name'), ('django_admin_settings', '0002_options_valid'),]

    operations = [
        migrations.CreateModel(
            name='Menu',
            fields=[('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                    ('path', models.CharField(max_length=255, unique=True)), ('depth', models.PositiveIntegerField()),
                    ...
                    (
                        'link_type',
                        models.IntegerField(
                            choices=[(0, 'Internal'), (1, 'External')], default=0, verbose_name='Link Type'
                        )
