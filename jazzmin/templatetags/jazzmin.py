...
@register.simple_tag(takes_context=True)
def get_top_menu(context: Context, user: AbstractUser, admin_site: str = "admin") -> List[Dict[str, Any]]:
    """
...
@register.simple_tag(takes_context=True)
def get_user_menu(context: Context, user: AbstractUser, admin_site: str = "admin") -> List[Dict[str, Any]]:
    """
